...
let AppController = class AppController {
    ...
    updateStatusDo(orderId, payload) {
        return this.appService.updateStatusDo(orderId, payload);
    }
    updateDo(orderId, payload) {
...
__decorate([
    (0, common_1.Put)('invoke/status-do/:orderId'),
    __param(0, (0, common_1.Param)('orderId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_status_do_dto_1.UpdateStatusDoDto]),
    __metadata("design:returntype", void 0)
], AppController.prototype, "updateStatusDo", null);
__decorate([
    (0, common_1.Put)('invoke/do/:orderId'),
    __param(0, (0, common_1.Param)('orderId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_do_dto_1.UpdateDoDto]),
    __metadata("design:returntype", void 0)
], AppController.prototype, "updateDo", null);
__decorate([
